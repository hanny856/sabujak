<%@page contentType="text/html;charset=utf-8" import="java.util.ArrayList, sabujak.domain.Sabujak"%>
...
<body>
   <div id="wrap"> <!--**** #wrap start ****-->
      ...
      <div id="writeform" style="width: 60%; margin: auto;">
         <form name= "input" method="post" action="sabujak.do?m=update&c_no=${sabujak.c_no}" enctype="multipart/form-data">
              <br/>
            <input type="hidden" name="m">
            <input type="text" name="writer" style="width: 27.2%;" value="${sabujak.email_fk_pk}" />
            <input id="subBtn" type="submit" value="수정하기"/>
            <br>
            <input type="text" name="title" style="width: 40%;" placeholder="제목" value="${sabujak.c_sub}"/>
			<br>
 			 <input name='fname' value="${sabujak.c_ofname}" size="73"/> <input type="file" name="newfname">
			<br> 
            <textarea id="summernote" name="content" >${sabujak.c_cont}</textarea>
