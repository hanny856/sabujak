...
<body>
   <div id="wrap"> <!--**** #wrap start ****-->
      ...
      <div id="writeform" style="width: 60%; margin: auto;">
         <form name= "input" method="post" action="sabujak.do?m=insert" enctype="multipart/form-data">
              <br/>
             <input type="hidden" name="m">

            <input type="text" name="writer" style="width: 27.2%;" value="${loginUser.email}" readonly/>
