...
<body>
   <div id="wrap"> <!--**** #wrap start ****-->
      ...
      <div id="writeform" style="width: 60%; margin: auto;">
         <form name= "input" method="post" action="board.do?m=updateOk&n_no=${Notice.n_no}" enctype="multipart/form-data">
              <br/>
            <input type="hidden" name="m">
            <input type="text" name="writer" style="width: 27.2%;" value="${Notice.email_fk}" readonly/>
            <input id="subBtn" type="submit" value="수정하기"/>
            <br>
            <input type="text" name="title" style="width: 40%;" placeholder="제목" value="${Notice.n_sub}"/>
			<br>
 			 <input name='ofname' value="${Notice.ofname}" size="73"/ readonly> <input type="file" name="fname"> 
			<br> 
            <textarea id="summernote" name="content" >${Notice.n_cont}</textarea>
