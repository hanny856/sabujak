	...
	<div id="wrap"> <!--**** #wrap start ****-->
		...
		<div id="writeform" style="width: 60%; margin: auto;">
			<form name= "input" method="post" action="board.do?m=insert" enctype="multipart/form-data">
			  ...
			  <select id="category" name="category" onchange="setValue(this.value);">	   
			  	   <option value="0" selected>글 분류 선택</option>
			       <option value="1" >영화리뷰</option>
			       <option value="2">자동차DIY</option>
			       <option value="3">가든DIY</option>
			  </select>
			
				<input type="text" name="writer" style="width: 23.5%;" value="${loginUser.email}" readonly/>
				  <input id="subBtn" type="button" value="글쓰기 " onclick="check()" />
				
				<br />
				<input type="text" name="title"  placeholder="제목"  style="width: 100%; height: 30px;" />
				
				<br /><br /> 
				
				<textarea id="summernote" name="content"></textarea>
				썸네일 선택 : <input type="file" name="fname" accept=".gif, .jpg, .png">
				<br /><br /> 
